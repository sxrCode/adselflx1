...
import com.gss.cordova.camera.listener.ErrorListener;
import com.gss.cordova.camera.util.AngleUtil;
import com.gss.cordova.camera.util.CameraParamUtil;
import com.gss.cordova.camera.util.CheckPermission;
import com.gss.cordova.camera.util.DeviceUtil;
import com.gss.cordova.camera.util.FileUtil;
import com.gss.cordova.camera.util.LogUtil;
import com.gss.cordova.camera.util.ScreenUtils;
...
/**
 * ===================================== 作 者: 陈嘉桐 版 本：1.1.4 创建日期：2017/4/25 描
 * 述：camera操作单例 =====================================
 */
...
public class CameraInterface implements Camera.PreviewCallback {
	...
	public void startRecord(Surface surface, float screenProp, ErrorCallback callback) {
		...
		videoFirstFrame = createBitmap(videoFirstFrame, 0, 0, videoFirstFrame.getWidth(), videoFirstFrame.getHeight(),
				matrix, true);
