package com.gss.cordova.camera.state;

import com.gss.cordova.camera.CameraInterface;
...
/**
 * ===================================== 作 者: 陈嘉桐 版 本：1.1.4 创建日期：2017/9/8 描 述：
 * =====================================
 */
public class CameraMachine implements State {
	...
	public CameraMachine(Context context, CameraView view,
			CameraInterface.CameraOpenOverCallback cameraOpenOverCallback) {
