...
import com.gss.cordova.camera.listener.CaptureListener;
...
/**
 * ===================================== 作 者: 陈嘉桐 445263848@qq.com 版 本：1.1.4
 * 创建日期：2017/4/25 描 述：拍照按钮 =====================================
 */
public class CaptureButton extends View {
	...
	public CaptureButton(Context context, int size) {
		...
		rectF = new RectF(center_X - (button_radius + outside_add_size - strokeWidth / 2),
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			if (captureLisenter != null && state == STATE_RECORDERING
	...
	private void handlerUnpressByState() {
		...
		// 当前是点击按下
		case STATE_PRESS:
			if (captureLisenter != null && (button_state == JCameraView.BUTTON_STATE_ONLY_CAPTURE
					|| button_state == JCameraView.BUTTON_STATE_BOTH)) {
	...
	private class LongPressRunnable implements Runnable {
		...
		public void run() {
			...
			// 启动按钮动画，外圆变大，内圆缩小
			startRecordAnimation(button_outside_radius, button_outside_radius + outside_add_size, button_inside_radius,
